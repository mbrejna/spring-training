...
class TemplateTest {
    ...
    @Test
    void given_a_text_with_expressions_when_evaluate_then_return_the_text_with_substituted_values() {
    ...
    @Test
    void given_a_text_with_expressions_when_evaluate_without_providing_all_values_then_throws_an_exception() {
